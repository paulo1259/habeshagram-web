...
export function CreatePostForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-3xl border border-brand-100 bg-white/95 p-5 shadow-soft">
      {!currentUser ? (
      ...
      <textarea
        ...
        className="w-full rounded-3xl border border-brand-100 bg-brand-50/50 p-4 text-sm outline-none ring-brand-300 focus:ring-2"
      />
