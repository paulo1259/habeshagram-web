...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/[0.06] bg-surface/80 backdrop-blur-2xl">
      ...
      <div className="mx-auto flex max-w-[1180px] items-center gap-2.5 px-3 py-2.5 sm:gap-3 sm:px-4 lg:py-3">
        <Link
          href="/"
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {currentUser ? (
            ...
            <Link
              href="/login"
              className="btn-glow inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm hover:-translate-y-0.5 active:scale-[0.97]"
            >
              Sign in
            </Link>
          )}
