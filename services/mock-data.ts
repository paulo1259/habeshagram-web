...
export const initialState: AppState = {
  users: [
    ...
    {
      id: "user_3",
      username: "addis.nightlife",
      email: "nightlife@habeshagram.com",
      profileImageURL: "",
      bio: "City nights, memes, and late reactions from Addis.",
    ...
    },
    {
      ...
      profileImageURL: "",
      bio: "Street style and weekend looks with Habesha energy.",
  ...
  posts: [
    ...
    },
    {
      ...
      username: "addis.nightlife",
      userProfileImageURL: "",
      text: "Addis coffee culture debate: is the third round of buna the best one, or is that just nostalgia talking?",
      imageURL: "",
      hashtags: ["buna", "addis", "culture"],
    ...
    },
    {
      ...
      username: "habesha.fitcheck",
      userProfileImageURL: "",
      text: "Habesha kemis with clean white sneakers might be the strongest weekend combo in the city. No one is changing my mind.",
      imageURL: "https://images.unsplash.com/photo-1517466787929-bc90951d0974?auto=format&fit=crop&w=1200&q=80",
      hashtags: ["fashion", "habesha", "weekend"],
    ...
    },
    {
      ...
      username: "asmara.vibes",
      userProfileImageURL: "",
      text: "Diaspora group chats really know how to turn every new restaurant opening into a full-blown review thread by midnight.",
      imageURL: "",
      hashtags: ["food", "diaspora", "habesha"],
    ...
    },
    {
      ...
      username: "addis.nightlife",
      userProfileImageURL: "",
      text: "New Ethio-jazz nights are popping up across the city, and the timelines still debate every setlist the morning after.",
      imageURL: "",
      hashtags: ["ethiojazz", "music", "addis"],
